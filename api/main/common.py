...
def before_request():
    ...
    if request.method == 'GET':
        get_list = [
            "/",
            "/apidocs/",
             "/pythons53e51x2/examusers/login" ,
            "/pythons53e51x2/examusers/register",
            '/pythons53e51x2/defaultuser/login',
            '/pythons53e51x2/users/login',
        ...
        post_list = [
            '/pythons53e51x2/defaultuser/register',
            '/pythons53e51x2/defaultuser/login',
            '/pythons53e51x2/users/register',
            '/pythons53e51x2/users/login',
            "/pythons53e51x2/examusers/login" ,
            "/pythons53e51x2/examusers/register"
        ]  # 免认证list
