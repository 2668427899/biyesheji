...
# 注册接口
@main_bp.route("/pythons53e51x2/yonghu/register", methods=['POST'])
def pythons53e51x2_yonghu_register():
...
# 登录接口
@main_bp.route("/pythons53e51x2/yonghu/login", methods=['GET','POST'])
def pythons53e51x2_yonghu_login():
...
# 登出接口
@main_bp.route("/pythons53e51x2/yonghu/logout", methods=['POST'])
def pythons53e51x2_yonghu_logout():
    if request.method == 'POST':
        msg = {
            "msg": "退出成功",
            "code": 0
...
# 重置密码接口
@main_bp.route("/pythons53e51x2/yonghu/resetPass", methods=['POST'])
def pythons53e51x2_yonghu_resetpass():
    '''
    '''
    if request.method == 'POST':
...
# 获取会话信息接口
@main_bp.route("/pythons53e51x2/yonghu/session", methods=['GET'])
def pythons53e51x2_yonghu_session():
    '''
    '''
...
# 分类接口（后端）
@main_bp.route("/pythons53e51x2/yonghu/page", methods=['GET'])
def pythons53e51x2_yonghu_page():
    '''
    '''
    if request.method == 'GET':
...
# 排序接口
@main_bp.route("/pythons53e51x2/yonghu/autoSort", methods=['GET'])
def pythons53e51x2_yonghu_autosort():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 分页接口（前端）
@main_bp.route("/pythons53e51x2/yonghu/list", methods=['GET'])
def pythons53e51x2_yonghu_list():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 保存接口（后端）
@main_bp.route("/pythons53e51x2/yonghu/save", methods=['POST'])
def pythons53e51x2_yonghu_save():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 添加接口（前端）
@main_bp.route("/pythons53e51x2/yonghu/add", methods=['POST'])
def pythons53e51x2_yonghu_add():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 踩、赞接口
@main_bp.route("/pythons53e51x2/yonghu/thumbsup/<id_>", methods=['GET'])
def pythons53e51x2_yonghu_thumbsup(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（后端）
@main_bp.route("/pythons53e51x2/yonghu/info/<id_>", methods=['GET'])
def pythons53e51x2_yonghu_info(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（前端）
@main_bp.route("/pythons53e51x2/yonghu/detail/<id_>", methods=['GET'])
def pythons53e51x2_yonghu_detail(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 更新接口
@main_bp.route("/pythons53e51x2/yonghu/update", methods=['POST'])
def pythons53e51x2_yonghu_update():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 删除接口
@main_bp.route("/pythons53e51x2/yonghu/delete", methods=['POST'])
def pythons53e51x2_yonghu_delete():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 投票接口
@main_bp.route("/pythons53e51x2/yonghu/vote/<int:id_>", methods=['POST'])
def pythons53e51x2_yonghu_vote(id_):
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success"}
...
# 分组统计接口
@main_bp.route("/pythons53e51x2/yonghu/group/<columnName>", methods=['GET'])
def pythons53e51x2_yonghu_group(columnName):
    '''
    分组统计接口
    '''
    if request.method == 'GET':
        ...
        app.executor.submit(spark_read_mysql, f"({sql}) "+'yonghu', json_filename)
...
# 按值统计接口
@main_bp.route("/pythons53e51x2/yonghu/value/<xColumnName>/<yColumnName>", methods=['GET'])
def pythons53e51x2_yonghu_value(xColumnName, yColumnName):
    '''
    按值统计接口,
    {
        "code": 0,
...
# 按日期统计接口
@main_bp.route("/pythons53e51x2/yonghu/value/<xColumnName>/<yColumnName>/<timeStatType>", methods=['GET'])
def pythons53e51x2_yonghu_value_riqi(xColumnName, yColumnName, timeStatType):
    '''
    按日期统计接口
    '''
    if request.method == 'GET':
...
# 按值统计（多）
@main_bp.route("/pythons53e51x2/yonghu/valueMul/<xColumnName>", methods=['GET'])
def pythons53e51x2_yonghu_valueMul(xColumnName):
...
# 按值统计（多）
@main_bp.route("/pythons53e51x2/yonghu/valueMul/<xColumnName>/<timeStatType>", methods=['GET'])
def pythons53e51x2_yonghu_valueMul_time(xColumnName):
...
# 统计接口
@main_bp.route("/pythons53e51x2/yonghu/remind/<columnName>/<type>", methods=['GET'])  #
def pythons53e51x2_yonghu_remind(columnName,type):
    '''
    '''
    if request.method == 'GET':
...
#分类列表
@main_bp.route("/pythons53e51x2/yonghu/lists", methods=['GET'])
def pythons53e51x2_yonghu_lists():
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": []}
