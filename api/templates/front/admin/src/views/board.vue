	...
	<div class="content" :style='{"alignContent":"flex-start","overflow":"hidden","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231223/2592f2b1d33d45d299f892501055ed24.jpg) no-repeat center top / 100% 100%","display":"flex","width":"100%","position":"relative","height":"100vh"}'>
		...
		<div :style='{"padding":"20px 20px 0","display":"flex","height":"calc(100vh - 95px)"}'>
			...
			<div :style='{"width":"40%","padding":"0 20px","flexWrap":"wrap","display":"flex"}'>
				...
				<div class="tables">
					<div :style='{"margin":"0 0 20px 0","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","width":"100%","fontSize":"16px","height":"42px"}'>手机</div>
					<el-table :data="boardDataList" border :stripe="false" :style='{"width":"100%","padding":"0","borderColor":"rgba(92,135,230,.3)","borderStyle":"solid","borderWidth":"1px 0 0 1px","background":"none"}'>
						...
						<el-table-column :resizable="true" :sortable="false" prop="yxnc" label="运行内存"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="jsys" label="机身颜色"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="jsnc" label="机身内存"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="hszxs" label="后摄主像素"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="fengge" label="风格"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="xiaoliang" label="评论数"/>
						</el-table-column>
					</el-table>
				</div>
			</div>
			<div :style='{"width":"30%","padding":"0 20px","flexWrap":"wrap","display":"flex"}'>
				...
				<div class="echarts5">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="shoujiChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
...
//统计接口1
    shoujiChat1() {
      this.$nextTick(()=>{
        ...
        var shoujiChart1 = echarts.init(document.getElementById("shoujiChart1"),'macarons');
        this.$http({
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
				...
				this.myChartInterval(1, option.xAxis.data, option.series[0].data, shoujiChart2)
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
				...
				this.myChartInterval(1, option.xAxis.data, option.series[0].data, shoujiChart3)
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
				...
				this.myChartInterval(2, option.yAxis.data, option.series[0].data, shoujiChart4)
...
//统计接口5
    shoujiChat5() {
      this.$nextTick(()=>{
        ...
        var shoujiChart5 = echarts.init(document.getElementById("shoujiChart5"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                shoujiChart5.setOption(option);

				this.myChartInterval(1, option.xAxis.data, option.series[0].data, shoujiChart5)
